...
export default function FileStorageUploader() {
  ...
  const onPick = async (file?: File) => {
    ...
    try {
      ...
      await upload.mutateAsync({ fileName: file.name, mimeType: file.type || "application/octet-stream", sizeBytes: file.size, context, dataBase64 });
